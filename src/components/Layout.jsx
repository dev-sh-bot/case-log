...
const Layout = ({ children }) => {
  ...
  return (
    <>
      ...
      <div className="position-relative top-0 flex h-screen w-full overflow-auto bg-gray-50 dark:bg-facebook-dark">
        <Sidebar isExpanded={openSidebar} setIsExpanded={setOpenSidebar} />
        <main className={`w-full transition-all duration-300 ${openSidebar ? 'main-container' : 'main-container-expanded'} bg-gray-50 dark:bg-facebook-dark`}>
          <Header />
          <div className='p-5'>
            {children}
          </div>
